...
def main():
    genelist = find_genes("phage.gb")

    cdslist = find_cds("phage.gb")
    sequence = read_fasta("phage.fasta")
    ...
    pandoradf.to_csv('phage.csv', encoding='utf-8', index=False)

    pandora = Genome("phage", gene_object_list, sequence=sequence)
